...
In this exercise, we will run a full simulation on 4LZT and process its microstates ensemble to produce 'charge miscrostates' for further analysis  using **MCCE4**.
